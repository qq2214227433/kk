...
<td colid=1 class='t01'><span class='t0'>&nbsp;<div class='t1'><table border=0><tr><td valign=top>ID：<?php echo $_MMVAR_9a036496d66f59815a['id'] ?><br><?php echo _MMFUN_59e7c3854a78f9e590($_MMVAR_9a036496d66f59815a['addtime'],5) ?><br><?php echo $_MMVAR_9a036496d66f59815a['ordernum']=='0'?'':'订单号：'.$_MMVAR_9a036496d66f59815a['ordernum'].'<br>'?><span  <?php if($_MMVAR_7b23ccb22c0a2536fd=='1') echo 'title=\'spcode:'.$_MMVAR_9a036496d66f59815a['v7ext2'].'\'';?>>绑定机器码：<?php echo $_MMVAR_bac4c643bf8a5895c9 ?></span><br>加或减时(减时用负数)<input type="text" maxlength="5" class="sml1inputText" value=0 id="js<?php echo $_MMVAR_9a036496d66f59815a['id'] ?>">天<br><input class="jsbtn" kid="<?php echo $_MMVAR_9a036496d66f59815a['id'] ?>" type="button" value="确认操作"></td><td style='border-left:1px solid #ddd'>
标签：<input type="text" maxlength="18" style="width:100px;height:18px;line-height:18px" value="<?php echo $_MMVAR_9a036496d66f59815a['ext1'] ?>" name="ext1" id="ext1<?php echo $_MMVAR_9a036496d66f59815a['id'] ?>"> 点数:<input type="text" maxlength="5" style="width:30px;height:18px;line-height:18px" value="<?php echo $_MMVAR_9a036496d66f59815a['dayactivetimes'] ?>" name="dayactivetimes" id="dayactivetimes<?php echo $_MMVAR_9a036496d66f59815a['id'] ?>">  分区:<input type="text" maxlength="5" style="width:30px;height:18px;line-height:18px" value="<?php echo $_MMVAR_9a036496d66f59815a['int1'] ?>" name="int1" id="int1<?php echo $_MMVAR_9a036496d66f59815a['id'] ?>">  <br /><textarea class="keyintro" name="intro" keyid="<?php echo $_MMVAR_9a036496d66f59815a['id'] ?>"  id="intro<?php echo $_MMVAR_9a036496d66f59815a['id'] ?>"><?php echo htmlspecialchars($_MMVAR_9a036496d66f59815a['intro']) ?></textarea><br />
连接:<input type="text" maxlength="3" style="width:30px;height:18px;line-height:18px" value="<?php echo $_MMVAR_9a036496d66f59815a['linknum'] ?>" name="linknum" id="linknum<?php echo $_MMVAR_9a036496d66f59815a['id'] ?>">  绑定信息:<input type="text" maxlength="99" style="width:120px;height:18px;line-height:18px" value="<?php echo $_MMVAR_9a036496d66f59815a['v7ext1'] ?>" name="v7ext1" id="v7ext1<?php echo $_MMVAR_9a036496d66f59815a['id'] ?>">  <input class="saveintro" kid="<?php echo $_MMVAR_9a036496d66f59815a['id'] ?>" name="nnoo" type="button" value="保存修改">
