...
list($_MMVAR_7b6896960481a4d007, $_MMVAR_4fe7aad9574dbe6e2d, $_MMVAR_0b2e3ad4d3a65dc3bd, $_MMVAR_6ecc0d16521a4508ea, $_MMVAR_4a9f8efac528d03123, $_MMVAR_c90455ba5250dd5068, $_MMVAR_71e6303534ceac4f32, $_MMVAR_3646bf05f90f5a2181,$_MMVAR_a5afa007e70518d858)=$_MMVAR_a9ecec9b36cd18d921;
$_MMVAR_c90455ba5250dd5068=_MMFUN_4bb069f11df5d99e54($_MMVAR_c90455ba5250dd5068);
$_MMVAR_4fe7aad9574dbe6e2d=_MMFUN_c3428c7e6251d22b7d($_MMVAR_4fe7aad9574dbe6e2d);
$_MMVAR_0b2e3ad4d3a65dc3bd=_MMFUN_4bb069f11df5d99e54($_MMVAR_0b2e3ad4d3a65dc3bd);
...
$_MMVAR_be0ff7fbb4af7d07f5=$_MMVAR_9f95914834184aeeae->_MMFUN_2ae87f854725528ae4('select * from `'.$_MMVAR_3fc22e00af1642a292.'` where `keys`=\''.$_MMVAR_4fe7aad9574dbe6e2d.'\'');
if(empty($_MMVAR_be0ff7fbb4af7d07f5))
exit('解绑失败：注册卡错误！'); 
if($_MMVAR_be0ff7fbb4af7d07f5['isdel']==1)
exit('解绑失败：注册卡错误已被删除！');			
}else{
$_MMVAR_be0ff7fbb4af7d07f5=$_MMVAR_9f95914834184aeeae->_MMFUN_2ae87f854725528ae4('select * from `'.$_MMVAR_3fc22e00af1642a292.'` where `cusername`=\''.$_MMVAR_4fe7aad9574dbe6e2d.'\'');
if(empty($_MMVAR_be0ff7fbb4af7d07f5))
exit('解绑失败：用户名错误');
if($_MMVAR_be0ff7fbb4af7d07f5['isdel']==1)
exit('解绑失败：用户已被删除');
if($_MMVAR_be0ff7fbb4af7d07f5['cpassword'] != $_MMVAR_0b2e3ad4d3a65dc3bd)
exit('解绑失败：用户密码错误');
}	
...
$_MMVAR_9f95914834184aeeae->_MMFUN_9186ce7fdb77ebe6df('UPDATE `'.$_MMVAR_3fc22e00af1642a292.'` SET `chkcode`=\'aaaaaaaaa\', `bdcode`=\'1001\''.$_MMVAR_3bf534660d00be59f7.$_MMVAR_3a2e6f3d72f1e544a8.' where `keys`=\''.$_MMVAR_be0ff7fbb4af7d07f5['keys'].'\'', 'sync');
...
global $_MMVAR_9f95914834184aeeae;
list($_MMVAR_7b6896960481a4d007, $_MMVAR_4fe7aad9574dbe6e2d, $_MMVAR_0b2e3ad4d3a65dc3bd, $_MMVAR_6ecc0d16521a4508ea, $_MMVAR_4a9f8efac528d03123, $_MMVAR_c90455ba5250dd5068, $_MMVAR_71e6303534ceac4f32, $_MMVAR_3646bf05f90f5a2181,$_MMVAR_a5afa007e70518d858)=$_MMVAR_a9ecec9b36cd18d921;
if(_MMFUN_b975f45914ee3d5106($_MMVAR_4fe7aad9574dbe6e2d) < 3)
exit('用户名3位字符以上！');

$_MMVAR_bb6713f19abe5e75c5=_MMFUN_c3428c7e6251d22b7d($_MMVAR_4fe7aad9574dbe6e2d);		
$_MMVAR_4fe7aad9574dbe6e2d=_MMFUN_4bb069f11df5d99e54($_MMVAR_4fe7aad9574dbe6e2d);
...
if(_MMFUN_b975f45914ee3d5106($_MMVAR_4a9f8efac528d03123) < 8 || _MMFUN_b975f45914ee3d5106($_MMVAR_4a9f8efac528d03123) >20 || !_MMFUN_72287d2d89425c2782($_MMVAR_4a9f8efac528d03123))
exit('超级密码必须是8-20个字符的英文或数字。');

if(_MMFUN_b975f45914ee3d5106($_MMVAR_0b2e3ad4d3a65dc3bd) < 5 || _MMFUN_b975f45914ee3d5106($_MMVAR_0b2e3ad4d3a65dc3bd) >20 || !_MMFUN_72287d2d89425c2782($_MMVAR_0b2e3ad4d3a65dc3bd))
...
$_MMVAR_87e4ed813b9c6dfa1b=$_MMVAR_9f95914834184aeeae->_MMFUN_2ae87f854725528ae4('select * from '.TNREG.'_havereg where xjlid='.$_MMVAR_e9ffef5bdc7675ff63['id'].' and `cusername`=\''.$_MMVAR_bb6713f19abe5e75c5.'\' '.$_MMVAR_d4eb7ade2f075d12e2);
...
$_MMVAR_ad5fc4eaa7e0988e1e=',v7ext1=\''.$_MMVAR_6ecc0d16521a4508ea.'\' ';
...
'isused'=>2,
'intro'=>$_MMVAR_4fe7aad9574dbe6e2d,
...
'v7ext1'=>$_MMVAR_6ecc0d16521a4508ea
);
...
$_MMVAR_9f95914834184aeeae->_MMFUN_9186ce7fdb77ebe6df('UPDATE `'.$_MMVAR_3fc22e00af1642a292.'` SET `cusername`=\''.$_MMVAR_bb6713f19abe5e75c5.'\', `cpassword`=\''.$_MMVAR_0b2e3ad4d3a65dc3bd.'\', `ext2`=\''.$_MMVAR_4a9f8efac528d03123.'\', `isused`=2, cday='.($_MMVAR_e4166e802d490cbfbf+$_MMVAR_303322a92013db2b0d).', deltime='.time().',intro=\''.$_MMVAR_4fe7aad9574dbe6e2d.'\''.$_MMVAR_ad5fc4eaa7e0988e1e.' where `keys`=\''.$_MMVAR_a5f72524ded13edf27[0].'\'', 'sync');
}else{
$_MMVAR_9f95914834184aeeae->_MMFUN_9186ce7fdb77ebe6df('UPDATE `'.$_MMVAR_3fc22e00af1642a292.'` SET `isused`=1, deltime='.time().',intro=\''.$_MMVAR_4fe7aad9574dbe6e2d.'\' where `keys`=\''.$_MMVAR_a5f72524ded13edf27[$_MMVAR_8fdbca33e031eb6432].'\'', 'sync');
}
}
...
exit('注册用户成功，帐号可使用时间'.($_MMVAR_e4166e802d490cbfbf+$_MMVAR_fb299babe9700c932e)."天！\r\n（使用的卡类型：".$_MMVAR_a9a832cc2eb685881b.$_MMVAR_c4c4e5a38df8acea64.'）');
}
...
if(!empty($_MMVAR_e184a42e36062e2b67[$_MMVAR_8ff60a7771c3f2c087]['agentid']) && empty($_MMVAR_d4e2d1a70a5ec2d36e))
...
$_MMVAR_9f95914834184aeeae->_MMFUN_9186ce7fdb77ebe6df('UPDATE `'.$_MMVAR_3fc22e00af1642a292.'` SET `ext1`=\''.$_MMVAR_f8e22f88aa3ec7edea.'\', cday='.($_MMVAR_350816a7d3bdc2711f['cday'] + $_MMVAR_e4166e802d490cbfbf + $_MMVAR_ab9c61c4fe337136b4).$_MMVAR_d4e2d1a70a5ec2d36e.' where `keys`=\''.$_MMVAR_350816a7d3bdc2711f['keys'].'\'', 'sync');
$_MMVAR_9fecb5494f62ff4f6c['u1d2']=$_MMVAR_350816a7d3bdc2711f['cday'] + $_MMVAR_e4166e802d490cbfbf+$_MMVAR_ab9c61c4fe337136b4;
$_MMVAR_9f95914834184aeeae->_MMFUN_d5033eea64260e1006(TNREG.'_timelog', $_MMVAR_9fecb5494f62ff4f6c, 'nosync');
exit('充值完成，给帐户 ['._MMFUN_4ea6f8ac8f03aa7c6f($_MMVAR_bb6713f19abe5e75c5).'] 添加了'.($_MMVAR_e4166e802d490cbfbf+$_MMVAR_ab9c61c4fe337136b4).'天有效期'.$_MMVAR_169619a0bb2962f836.'，计时从下次登陆算起！');
}else{
if(intval($_MMVAR_350816a7d3bdc2711f['activetime']) + $_MMVAR_350816a7d3bdc2711f['cday'] * 86400 < time()){
$_MMVAR_9f95914834184aeeae->_MMFUN_9186ce7fdb77ebe6df('UPDATE `'.$_MMVAR_3fc22e00af1642a292.'` SET `ext1`=\''.$_MMVAR_f8e22f88aa3ec7edea.'\', `activetime`='.time().', `cday`='.($_MMVAR_e4166e802d490cbfbf+$_MMVAR_ab9c61c4fe337136b4).', `endtime`='.(time() + $_MMVAR_e4166e802d490cbfbf * 86400).$_MMVAR_d4e2d1a70a5ec2d36e.' where `keys`=\''.$_MMVAR_350816a7d3bdc2711f['keys'].'\'', 'sync');
$_MMVAR_9fecb5494f62ff4f6c['u1d1']=0.01;
$_MMVAR_9fecb5494f62ff4f6c['u1d2']=$_MMVAR_e4166e802d490cbfbf+$_MMVAR_ab9c61c4fe337136b4;
$_MMVAR_9f95914834184aeeae->_MMFUN_d5033eea64260e1006(TNREG.'_timelog', $_MMVAR_9fecb5494f62ff4f6c, 'nosync');
exit('充值完成，给帐户 ['._MMFUN_4ea6f8ac8f03aa7c6f($_MMVAR_bb6713f19abe5e75c5).'] 添加了'.($_MMVAR_e4166e802d490cbfbf+$_MMVAR_ab9c61c4fe337136b4).'天有效期'.$_MMVAR_169619a0bb2962f836.'，计时从现在算起（因为原帐户已过期）！');
}else{
$_MMVAR_9f95914834184aeeae->_MMFUN_9186ce7fdb77ebe6df('UPDATE `'.$_MMVAR_3fc22e00af1642a292.'` SET	`ext1`=\''.$_MMVAR_f8e22f88aa3ec7edea.'\', `cday`='.($_MMVAR_350816a7d3bdc2711f['cday'] + $_MMVAR_e4166e802d490cbfbf+$_MMVAR_ab9c61c4fe337136b4).', `endtime`='.($_MMVAR_350816a7d3bdc2711f['endtime']+$_MMVAR_e4166e802d490cbfbf * 86400).$_MMVAR_d4e2d1a70a5ec2d36e.' where `keys`=\''.$_MMVAR_350816a7d3bdc2711f['keys'].'\'', 'sync');
$_MMVAR_9fecb5494f62ff4f6c['u1d2']=$_MMVAR_350816a7d3bdc2711f['cday'] + $_MMVAR_e4166e802d490cbfbf+$_MMVAR_ab9c61c4fe337136b4;
$_MMVAR_9f95914834184aeeae->_MMFUN_d5033eea64260e1006(TNREG.'_timelog', $_MMVAR_9fecb5494f62ff4f6c, 'nosync');
exit('充值完成，给帐户 ['._MMFUN_4ea6f8ac8f03aa7c6f($_MMVAR_bb6713f19abe5e75c5).'] 添加了'.($_MMVAR_e4166e802d490cbfbf+$_MMVAR_ab9c61c4fe337136b4).'天有效期'.$_MMVAR_169619a0bb2962f836.'，到期时间'._MMFUN_59e7c3854a78f9e590($_MMVAR_350816a7d3bdc2711f['endtime'] + $_MMVAR_e4166e802d490cbfbf * 86400, 1).'！');
}
}
}
...
list($_MMVAR_7b6896960481a4d007, $_MMVAR_4fe7aad9574dbe6e2d, $_MMVAR_8d313627193e4f141c, $_MMVAR_6ecc0d16521a4508ea, $_MMVAR_4a9f8efac528d03123, $_MMVAR_c90455ba5250dd5068, $_MMVAR_71e6303534ceac4f32, $_MMVAR_3646bf05f90f5a2181,$_MMVAR_a5afa007e70518d858)=$_MMVAR_a9ecec9b36cd18d921;
if(_MMFUN_b975f45914ee3d5106($_MMVAR_4fe7aad9574dbe6e2d) < 3)
exit('用户名或卡号长度少于3个字符！');



if($_MMVAR_8d313627193e4f141c!='' && (_MMFUN_b975f45914ee3d5106($_MMVAR_8d313627193e4f141c) < 2 || _MMFUN_b975f45914ee3d5106($_MMVAR_8d313627193e4f141c) > 99))
exit('绑定信息长度应该是2-99个字符！'.$_MMVAR_8d313627193e4f141c);		

$_MMVAR_bb6713f19abe5e75c5=_MMFUN_c3428c7e6251d22b7d($_MMVAR_4fe7aad9574dbe6e2d);	
$_MMVAR_0b2e3ad4d3a65dc3bd=_MMFUN_4bb069f11df5d99e54($_MMVAR_8d313627193e4f141c);	
...
if(empty($_MMVAR_e9ffef5bdc7675ff63))
exit('软件信息不存在！');		
if($_MMVAR_e9ffef5bdc7675ff63['editks']==99 && $_MMVAR_0b2e3ad4d3a65dc3bd != '')
...
if($_MMVAR_8d313627193e4f141c=='' && $_MMVAR_6ecc0d16521a4508ea=='')
exit('你没有输入任何要修改的资料！');	
...
if(strlen($_MMVAR_0b2e3ad4d3a65dc3bd) <2 && $_MMVAR_6ecc0d16521a4508ea=='0')
exit('绑定文本信息或绑定分区信息必填！');
...
if($_MMVAR_0b2e3ad4d3a65dc3bd != '' && $_MMVAR_8d313627193e4f141c==$_MMVAR_477afeb555696efb83['v7ext1'])
...
if($_MMVAR_0b2e3ad4d3a65dc3bd != ''){
$_MMVAR_d1d4a5e32b498d5107=0;
if($_MMVAR_e9ffef5bdc7675ff63['ext1']=='keys' && $_MMVAR_477afeb555696efb83['v7ext1']=='')
$_MMVAR_d1d4a5e32b498d5107=1;
if($_MMVAR_e9ffef5bdc7675ff63['editks']==0 || $_MMVAR_d1d4a5e32b498d5107==1){
$_MMVAR_e029ec35b9a7d66b2a=$_MMVAR_477afeb555696efb83['cday'];
$_MMVAR_ab3ae7484e49f139cc=' `v7ext1`=\''.$_MMVAR_0b2e3ad4d3a65dc3bd.'\' ';
}else{
...
$_MMVAR_ab3ae7484e49f139cc=' `cday`='.$_MMVAR_e029ec35b9a7d66b2a.', `v7ext1`=\''.$_MMVAR_0b2e3ad4d3a65dc3bd.'\' ';
}else{
...
$_MMVAR_ab3ae7484e49f139cc=' `cday`='.$_MMVAR_e029ec35b9a7d66b2a.',`endtime`='.$_MMVAR_adcb134fe04cdb86a9.', `v7ext1`=\''.$_MMVAR_0b2e3ad4d3a65dc3bd.'\' ';        
} 
if($_MMVAR_e9ffef5bdc7675ff63['ext1']=='keys')
...
if($_MMVAR_e9ffef5bdc7675ff63['ext1']=='user' && $_MMVAR_6ecc0d16521a4508ea!=''){
...
if($_MMVAR_ab3ae7484e49f139cc!='' && $_MMVAR_e9ffef5bdc7675ff63['ext1']=='user'){
$_MMVAR_9fecb5494f62ff4f6c=array(
'addtime'=>time(),
...
'u2d1'=>0,
'u2d2'=>0,
'intro'=>_MMFUN_c3428c7e6251d22b7d($_MMVAR_8d313627193e4f141c)
);
...
global $_MMVAR_9f95914834184aeeae;
list($_MMVAR_7b6896960481a4d007, $_MMVAR_bb6713f19abe5e75c5, $_MMVAR_0b2e3ad4d3a65dc3bd, $_MMVAR_6ecc0d16521a4508ea, $_MMVAR_4a9f8efac528d03123, $_MMVAR_c90455ba5250dd5068, $_MMVAR_71e6303534ceac4f32, $_MMVAR_3646bf05f90f5a2181,$_MMVAR_a5afa007e70518d858)=$_MMVAR_a9ecec9b36cd18d921;
...
function _MMFUN_90f382f8220c3338a0($_MMVAR_a9ecec9b36cd18d921){
global $_MMVAR_9f95914834184aeeae;
list($_MMVAR_7b6896960481a4d007, $_MMVAR_e4ec73debabb462e52, $_MMVAR_c690f92c6ab61dbacd, $_MMVAR_ae8e322c2757bb35bb, $_MMVAR_50362ad7ee1d274a2c, $_MMVAR_c90455ba5250dd5068, $_MMVAR_406df0a26c10d24f8f, $_MMVAR_b3954a5649c02a1576,$_MMVAR_a5afa007e70518d858)=$_MMVAR_a9ecec9b36cd18d921;
$_MMVAR_c90455ba5250dd5068=_MMFUN_4bb069f11df5d99e54($_MMVAR_c90455ba5250dd5068);
$_MMVAR_e4ec73debabb462e52=_MMFUN_4bb069f11df5d99e54($_MMVAR_e4ec73debabb462e52);
$_MMVAR_b3954a5649c02a1576=_MMFUN_4bb069f11df5d99e54($_MMVAR_b3954a5649c02a1576);
$_MMVAR_c690f92c6ab61dbacd=_MMFUN_4bb069f11df5d99e54($_MMVAR_c690f92c6ab61dbacd);
$_MMVAR_ae8e322c2757bb35bb=_MMFUN_4bb069f11df5d99e54($_MMVAR_ae8e322c2757bb35bb);
$_MMVAR_50362ad7ee1d274a2c=_MMFUN_4bb069f11df5d99e54($_MMVAR_50362ad7ee1d274a2c);
$_MMVAR_406df0a26c10d24f8f=_MMFUN_c3428c7e6251d22b7d($_MMVAR_406df0a26c10d24f8f);

$_MMVAR_e9ffef5bdc7675ff63=$_MMVAR_9f95914834184aeeae->_MMFUN_2ae87f854725528ae4('SELECT * from '.TNREG.'_xjl where `xjlcode`='.$_MMVAR_c90455ba5250dd5068);
if(empty($_MMVAR_e9ffef5bdc7675ff63))
exit(_MMFUN_a5a861282c21bfd0da('ERR要记录的信息，所属软件未找到！'));
$_MMVAR_3fc22e00af1642a292=TNREG.'_keys_'.$_MMVAR_e9ffef5bdc7675ff63['userid'].'_'.$_MMVAR_e9ffef5bdc7675ff63['id'];
$_MMVAR_9f95914834184aeeae->_MMFUN_9186ce7fdb77ebe6df('INSERT INTO `'.TNREG.'_getinfo` (`addtime`,`userid`,`xjlid`,`nameorkey`,`infotype`,`ext1`,`ext2`,`ext3`,`intro`) VALUES('.time().','.$_MMVAR_e9ffef5bdc7675ff63['userid'].','.$_MMVAR_e9ffef5bdc7675ff63['id'].',\''.$_MMVAR_406df0a26c10d24f8f.'\',\''.$_MMVAR_b3954a5649c02a1576.'\',\''.$_MMVAR_c690f92c6ab61dbacd.'\',\''.$_MMVAR_ae8e322c2757bb35bb.'\',\''.$_MMVAR_50362ad7ee1d274a2c.'\',\''.$_MMVAR_e4ec73debabb462e52.'\')', 'notsync');
exit(_MMFUN_a5a861282c21bfd0da('数据已记录'));
}
?>