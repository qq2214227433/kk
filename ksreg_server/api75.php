...
if(_MMFUN_b975f45914ee3d5106($_MMVAR_4a9f8efac528d03123) < 8 || _MMFUN_b975f45914ee3d5106($_MMVAR_4a9f8efac528d03123) >20)
exit('超级密码必须8个字符以上！');

if(_MMFUN_b975f45914ee3d5106($_MMVAR_0b2e3ad4d3a65dc3bd) < 5 || _MMFUN_b975f45914ee3d5106($_MMVAR_0b2e3ad4d3a65dc3bd) >20)
exit('登陆密码长度 小于5 或 大于20 个字符！');	
...
if(_MMFUN_b975f45914ee3d5106($_MMVAR_71e6303534ceac4f32) < 16){
...
exit('充值卡'.$_MMVAR_a5f72524ded13edf27[$_MMVAR_8ff60a7771c3f2c087].'被冻结了，不可充值！');
...
global $_MMVAR_9f95914834184aeeae;
list($_MMVAR_7b6896960481a4d007, $_MMVAR_4fe7aad9574dbe6e2d, $_MMVAR_0b2e3ad4d3a65dc3bd, $_MMVAR_6ecc0d16521a4508ea, $_MMVAR_4a9f8efac528d03123, $_MMVAR_c90455ba5250dd5068, $_MMVAR_71e6303534ceac4f32, $_MMVAR_3646bf05f90f5a2181)=$_MMVAR_a9ecec9b36cd18d921;
if(_MMFUN_b975f45914ee3d5106($_MMVAR_4fe7aad9574dbe6e2d) < 3)
exit('用户名3位字符以上！');
if(_MMFUN_b975f45914ee3d5106($_MMVAR_71e6303534ceac4f32) < 16)
exit('充值卡填写错误！');
...
exit('超级密码长度少于5个字符！');
if(_MMFUN_b975f45914ee3d5106($_MMVAR_6ecc0d16521a4508ea) < 5 || _MMFUN_b975f45914ee3d5106($_MMVAR_6ecc0d16521a4508ea) >20)
...
function _MMFUN_29604aa93cb2d5fdb7($_MMVAR_a9ecec9b36cd18d921){
global $_MMVAR_9f95914834184aeeae, $_MMVAR_9cb1706a7053f1b445;
list($_MMVAR_7b6896960481a4d007, $_MMVAR_4fe7aad9574dbe6e2d, $_MMVAR_8d313627193e4f141c, $_MMVAR_6ecc0d16521a4508ea, $_MMVAR_4a9f8efac528d03123, $_MMVAR_c90455ba5250dd5068, $_MMVAR_71e6303534ceac4f32, $_MMVAR_3646bf05f90f5a2181)=$_MMVAR_a9ecec9b36cd18d921;
if(_MMFUN_b975f45914ee3d5106($_MMVAR_4fe7aad9574dbe6e2d) < 3)
exit('用户名长度少于3个字符！');
if(_MMFUN_b975f45914ee3d5106($_MMVAR_4a9f8efac528d03123) < 8)
exit('超级密码长度少于8个字符！');
if(_MMFUN_b975f45914ee3d5106($_MMVAR_8d313627193e4f141c) < 2 || _MMFUN_b975f45914ee3d5106($_MMVAR_8d313627193e4f141c) > 99)
exit('合法的的绑定信息长度应该是2-99个字符！');		
...
exit('超级密码错误！');
if(intval($_MMVAR_477afeb555696efb83['normal']) !== 1)
exit('帐号被冻结了，不可修改绑定信息！');
if(intval($_MMVAR_477afeb555696efb83['isdel'])==1)
exit('老帐号在回收站，不可修改绑定信息！');

if($_MMVAR_8d313627193e4f141c==$_MMVAR_477afeb555696efb83['v7ext1'])
exit('绑定信息已经是'.$_MMVAR_8d313627193e4f141c.'，无需修改！');	

$_MMVAR_5470061abbb75fd751='';
...
$_MMVAR_ab3ae7484e49f139cc.=',`endtime`='.$_MMVAR_adcb134fe04cdb86a9.'';  
} 
...
exit('用户 ['.$_MMVAR_4fe7aad9574dbe6e2d.'] 绑定信息修改为 ['.$_MMVAR_8d313627193e4f141c.']成功！' );
}


function _MMFUN_78601124d5e6917c3d($_MMVAR_a9ecec9b36cd18d921){
global $_MMVAR_9f95914834184aeeae;
list($_MMVAR_7b6896960481a4d007, $_MMVAR_bb6713f19abe5e75c5, $_MMVAR_0b2e3ad4d3a65dc3bd, $_MMVAR_6ecc0d16521a4508ea, $_MMVAR_4a9f8efac528d03123, $_MMVAR_c90455ba5250dd5068, $_MMVAR_71e6303534ceac4f32, $_MMVAR_3646bf05f90f5a2181)=$_MMVAR_a9ecec9b36cd18d921;
...
global $_MMVAR_9f95914834184aeeae;
list($_MMVAR_7b6896960481a4d007, $_MMVAR_e4ec73debabb462e52, $_MMVAR_c690f92c6ab61dbacd, $_MMVAR_ae8e322c2757bb35bb, $_MMVAR_50362ad7ee1d274a2c, $_MMVAR_c90455ba5250dd5068, $_MMVAR_406df0a26c10d24f8f, $_MMVAR_b3954a5649c02a1576)=$_MMVAR_a9ecec9b36cd18d921;
$_MMVAR_c90455ba5250dd5068=_MMFUN_4bb069f11df5d99e54($_MMVAR_c90455ba5250dd5068);
