...
exit('200');
}elseif($_MMVAR_e21ee1d236d13da420=='TIMEERR'){
if($_MMVAR_7eae06bcce25334736==1)
...
$_MMVAR_b0b00e6800c176858c=explode(':|:', $_MMVAR_e21ee1d236d13da420);  $_MMVAR_f1c8cf7cf0e1561333="E";  $_MMVAR_be0ff7fbb4af7d07f5="";  $_MMVAR_80d88ec48b70fed130=0;
...
if(SVRID==1){
if($_MMVAR_b0b00e6800c176858c[0]=='reguser' || $_MMVAR_b0b00e6800c176858c[0]=='viewkey' || $_MMVAR_b0b00e6800c176858c[0]=='edituser3' || $_MMVAR_b0b00e6800c176858c[0]=='recharge1' || $_MMVAR_b0b00e6800c176858c[0]=='edituser2' || $_MMVAR_b0b00e6800c176858c[0]=='advapisenddata'){
$_MMVAR_f891938bc14c36bf02=count($_MMVAR_b0b00e6800c176858c);
if($_MMVAR_b0b00e6800c176858c[0]=='reguser'){
...
if(count($_MMVAR_b0b00e6800c176858c) > 8)
exit('向服务器发送的数据错误2，可能你输入的数据中有字符串:|:');				
exit('向服务器发送的数据错误2！');					
}
}	
...
$_MMVAR_0c24ae14cd1214a44f=$_MMVAR_0c24ae14cd1214a44f.':|:'.$_MMVAR_de06d08807cfd5bfb3;
}

$_MMVAR_0c24ae14cd1214a44f=_MMFUN_a5a861282c21bfd0da($_MMVAR_0c24ae14cd1214a44f);
