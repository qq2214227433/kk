...
$_MMVAR_6356c35a3d01d5ca1d=$_MMVAR_53d17c3545aae95b9e[0];
...
<form action="?action=report&userid=<?php echo $_MMVAR_d6858a6d9e9ee80bab ?>&sxjlid=<?php echo $_MMVAR_135a723a975f2e33a2 ?>" method="post" target="_self" id="f38" name="f38" onsubmit="return chkfrom37()">
<table width="980" style='border:0' border="0" cellpadding="0" class="list_tb" align="center">
<tr class="tb_tr2">
<td>软件名：<?php echo $_MMVAR_e9ffef5bdc7675ff63['xjlname'] ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	
<?php
...
$_MMVAR_dfcd951c40001f5a11=TNREG.'_keys_'.$_MMVAR_d6858a6d9e9ee80bab.'_'.$_MMVAR_135a723a975f2e33a2;
if($_MMVAR_e9ffef5bdc7675ff63['ext1']=='user'){
