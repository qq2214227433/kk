...
(function($) {
    ...
    var $msgbox = function(o) {
        ...
        opts.drag              = typeof o.drag != 'boolean' ? true: o.drag; 	// 默认禁止拖拽
        opts.animation         = typeof o.animation != 'number' ? 0 : o.animation  // 默认禁止动画
        ...
        function autoCloseMe(autoClose){            
            if( autoClose > 0 && isVisible() ){  // 防止人为关闭后,计时器还在运行
                autoCloseStr = "<font>" + autoClose + "秒后自动关闭</font>";
            ...
            switch(ctt.type){
                ...
                case 'alert':
                    ...
                    var $buttonWrapper = $("<div>")
                        ...
                        .appendTo($main);
                    var $OKButton = $("<input type=button value=' 确 定 '>")
                        .appendTo($buttonWrapper)
                        .addClass(opts.buttonClass)
                        .click(closeMe);
                    break;
